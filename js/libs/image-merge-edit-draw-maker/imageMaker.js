...
$(this).each(function (delta) {
     ...
     var canvas_info = {
        ...
        _maxWidth: 800,//The initial size that used for scale
        _maxHeight: 1000,
        position_left: 0,
        ratio_image: 1,
        ratio_width: 0,
...
MemeGeneratorTheme.wrapper_text = function (text_info) { 
    ...
    var HTML_FontFamilies = '';
      var checked = '';
        ...
        var InputShadow = '<div class="wrapperInputFontFamily"><label>'+canvas_info.i18n.shadowText+': </label><input class="InputShadow EventChange" var="shadowBlur" value="'+text_info.shadowBlur+'" type="checkbox" '+checked+'></div>';
